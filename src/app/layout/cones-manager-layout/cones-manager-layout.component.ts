...
@Component({
  selector: 'app-cones-manager-layout',
  standalone: true,
  imports: [
        ...
        <div class="p-4 border-b border-[var(--mehndi-border)]">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs opacity-60 mt-1">Cones Manager</p>
            </div>
          </div>
        </div>
      ...
      <mat-sidenav-content>
        <mat-toolbar class="!bg-[var(--mehndi-nav)] backdrop-blur-xl border-b border-[var(--mehndi-border)] sticky top-0 z-30">
          ...
          <div class="ml-2 hidden sm:block">
            <p class="text-xs uppercase tracking-[0.18em] text-[var(--mehndi-muted)]">Boutique & Inventory</p>
          </div>
          ...
          <mat-menu #userMenu xPosition="before">
            <div class="px-4 py-2 border-b border-[var(--mehndi-border)]">
              ...
              <p class="text-xs opacity-50">Cones Manager</p>
            </div>
...
export class ConesManagerLayoutComponent {
  ...
  navItems: NavItem[] = [
    { label: 'Dashboard', icon: 'dashboard', route: '/cones-manager/dashboard' },
    { label: 'Boutique Orders', icon: 'shopping_bag', route: '/cones-manager/orders' },
  ];
  ...
  onNotifClick(n: Notification): void {
    ...
    this.router.navigateByUrl('/cones-manager/orders');
  }
}
